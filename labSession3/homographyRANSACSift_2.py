...
if __name__ == '__main__':
    ...
    # Feature extraction
    sift = cv2.SIFT_create(nfeatures=0, nOctaveLayers = 5, contrastThreshold = 0.04, edgeThreshold = 10, sigma = 0.6)
...
#################################### RANSAC ####################################
    ...
    spFrac = 0.9    #nOutliers/nInliers  # spurious fraction
